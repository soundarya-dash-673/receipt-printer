/**
 * Safe wrapper around @brooons/react-native-bluetooth-escpos-printer.
 * The upstream index.js assigns properties on NativeModules at import time;
 * if BluetoothTscPrinter / BluetoothEscposPrinter is null (iOS Simulator, missing
 * native build), that throws "Cannot set property 'DIRECTION' of null".
 *
 * Metro resolves the package name to this file — see metro.config.js.
 */
